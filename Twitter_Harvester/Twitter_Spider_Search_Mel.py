...
ckey = 'hMs9oZlIot95QmZUiUGhsWUeB' #consumer key
csecret = 'FsF4SBW4dRNdKn5RAFjcsb7uPymWeTpeD9vmAGf30wWOpHZpKw' #consumer secret
atoken = '987955571801313281-2CoQ3dylbI3trdDQVpeCE6h2f1tzYqM' #access token
asecret = 'SYAdx4OEdC0UyuAdymH1XgWlwGtgoSFJdtc0NaNKx8upJ' #access secret
...
def search_tweets():
    ...
    while(True):
        try:
            for tweet in tweepy.Cursor(api.search, until = date_str, geocode="-37.810142,144.964302,250km", lang = "en").items():
                process_tweet(tweet)
