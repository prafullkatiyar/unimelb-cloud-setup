        ...
        for doc in features:
            ...
            for item in data_tweet['rows']:
                try:
                    ...
                    continue
            print(name_16,positve_count,negative_count, neutral_count )
            ...
            location_dict[name_16] = sentiment_dict
            list_location.append(location_dict)
    with open("sentiment_location.json", 'w') as f:
        data['total_rows'] = len(list_location)
        data['offset'] = '888888'
        data['rows'] = list_location
        json.dump(data,f)
